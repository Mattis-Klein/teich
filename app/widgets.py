...
class TopBar(QtWidgets.QFrame):
    ...
    def __init__(self, title: str, show_back: bool = True, show_home: bool = False, parent=None):
        super().__init__(parent)
        self.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.btn_home.setVisible(show_home)
...
class PlaceholderPage(QtWidgets.QWidget):
    ...
    def __init__(self, title: str, message: str, parent=None):
        ...
        self.top = TopBar(title, show_back=True, show_home=False)
